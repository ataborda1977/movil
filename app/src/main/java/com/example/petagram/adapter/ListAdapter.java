...
import com.example.petagram.ActivityContacto;
import com.example.petagram.ActivityDesarrollo;
...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.MascotaViewHolder> {
    ...
    public void onBindViewHolder(final MascotaViewHolder mascotaViewHolder,final int position) {
        ...
        mascotaViewHolder.imagenHuesoBlanco.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //mascotaViewHolder.cantidadLike.setText(constructorMascotas.consultarMascotaxID(mascota.getId()).getCantidadLike());
